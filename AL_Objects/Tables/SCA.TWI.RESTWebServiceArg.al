table 71016581 "SCA.TWI.RESTWebServiceArg"
{
    ...
    fields
    {
        ...
        field(6; UserName; text[50]) { DataClassification = CustomerContent; }
        field(7; Password; text[50]) { DataClassification = CustomerContent; }
